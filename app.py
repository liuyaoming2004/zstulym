...
def app():
    with gr.Blocks():
        ...
        gr.Examples(
            examples=[
                [
                "ultralytics/assets/test1.jpg",
                "lhxlbest.pt",
                640,
                0.25,
                 ],
                ["ultralytics/assets/test2.png","lhxlbest.pt",640,0.25],
                ["ultralytics/assets/2022331200164_79.jpg", "2022337621219best.pt", 640, 0.25],
            ],
